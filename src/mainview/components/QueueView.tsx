        ...
        <div className="px-6 pb-2 shrink-0">
          ...
          <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-app-active">
            {currentTrack.picture ? (
              <img src={currentTrack.picture} alt="" className="w-12 h-12 rounded-md object-cover" />
            ) : (
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[12px] text-app-text-tertiary truncate mt-0.5">{currentTrack.artist} · {currentTrack.album}</div>
            </div>
