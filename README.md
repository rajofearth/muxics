...
A Winamp-inspired cross-platform desktop music player built with Electron, React, Vite, and Tailwind CSS.
...
Summary
- 🎵 Cross-platform desktop app (macOS, Windows, Linux) with a nostalgic Winamp look.
